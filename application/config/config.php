...
*/
## Edit Config
$config['base_url'] = 'http://localhost/WebPUNPAS-CI3-System-Login/';
...
|
*/
## Edit Delete "index.php" | Default $config['index_page'] = 'index.php';
$config['index_page'] = '';
...
*/
## Edit to AUTO | Default REQUEST_URI
...
## add script sys_get_temp_dir() | Default NULL
